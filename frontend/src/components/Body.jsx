    ...
    return(
        <main>
            <section className="min-h-[50vh] p-8 py-24 flex flex-col gap-8 items-center">
                ...
                <p className="text-sm font-100">By using our service you are accepting our <a href="" className="text-(--accent) cursor-pointer">Terms of Use</a></p>
            </section>
            <section className="p-8 py-16 flex flex-col md:flex-row gap-8 items-top">
                ...
                <div className="flex flex-col p-4 gap-4 w-full md:w-1/2">
                    ...
                    <ol>
                        <li>1. Visit YouTube.com and find the specific video you want to save for offline use.</li>
